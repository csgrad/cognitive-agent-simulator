...
@del *.jpg
::RScript boxplot.R
matlab -r tp -nowindow -nosplash -nodesktop -minimize
timeout 10
matlab -r bestfiterrorgraph -nowindow -nosplash -nodesktop -minimize
timeout 10
matlab -r errorbargraph -nowindow -nosplash -nodesktop -minimize
timeout 10
goto:eof
